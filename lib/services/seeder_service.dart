  ...
  Future<void> seedDatabase() async {
    ...
    final List<Map<String, dynamic>> products = [
      ...
      },
      {
        ...
        'price': 9000.0,
        'imagePath': 'assets/images/tomatoes.jpg', // Placeholder merah
        'category': 'Fruits',
        'rating': 4.6,
        'stock': 40,
      },
      ...
      // --- KATEGORI VEGETABLES (Diperbanyak) ---
      {
      ...
      },
      {
        ...
        'price': 14000.0,
        'imagePath': 'assets/images/brocoli.jpg', // Placeholder mirip
        'category': 'Vegetables',
        'rating': 4.7,
        'stock': 15,
      },
      {
        ...
        'price': 13000.0,
        'imagePath': 'assets/images/tomatoes.jpg', // Placeholder
        'category': 'Vegetables',
        'rating': 4.6,
        'stock': 40,
      },
      ...
      },
      {
        ...
        'price': 10000.0,
        'imagePath': 'assets/images/grapes.jpg', // Placeholder warna ungu
        'category': 'Vegetables',
        'rating': 4.6,
        'stock': 25,
      },
    ...
    for (var prod in products) {
      ...
      // Fallback Image jika bukan asset bawaan (biar tidak error di UI)
      if (!['assets/images/avocado.jpg', 'assets/images/brocoli.jpg', 'assets/images/grapes.jpg', 'assets/images/tomatoes.jpg', 'assets/images/images.jpg'].contains(prod['imagePath'])) {
         // Gunakan salah satu gambar yang PASTI ada sebagai default placeholder
    ...
    await batch.commit();
    print("✅ DATA UPDATE (FRUITS/VEG/BREADS) BERHASIL DI-UPLOAD!");
  }
